...
master_doc = 'index'
project = u'Feng Lab - Python Coding Intro' # If you have the `conf.py` file but comment this out, it will title the docs `Python` it seems. But if you delete `conf.py` all together it will use the title you set in the read the docs set-up but will not have copyright names.
